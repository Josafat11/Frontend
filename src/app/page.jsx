...
import { FiChevronLeft, FiPhone ,FiArrowRight,FiUser,FiHeart ,FiShoppingCart, FiChevronRight } from "react-icons/fi";
...
function HomePage() {
  ...
  const categoriasPopulares = [
    ...
    "Eléctrico", "Filtros", "Aceites", "Carrocería"
  ];
  ...
  return (
<div className={`min-h-screen container mx-auto py-8 pt-36 ${
  theme === "dark" ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-900"
}`}>
  {/* Banner Promocional Mejorado */}
  <div className={`relative rounded-2xl overflow-hidden mb-12 h-96 md:h-80 lg:h-96 shadow-xl ${
    theme === "dark" 
    ...
    <div className="absolute inset-0 flex flex-col items-start justify-center p-8 md:p-12 lg:p-16 text-left">
      <span className={`px-4 py-2 rounded-full text-sm font-bold mb-4 ${
        theme === "dark" 
      ...
      <h2 className={`text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight ${
        ...
        Gran <span className="text-yellow-400">Descuento</span> en Refacciones
      </h2>
      
      <p className={`text-xl md:text-2xl mb-8 max-w-lg ${
        theme === "dark" ? "text-gray-300" : "text-gray-100"
      }`}>
        Hasta <span className="font-bold text-yellow-400">40% OFF</span> en piezas seleccionadas para tu vehículo
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <button className={`px-8 py-3 rounded-full font-bold border-2 transition-all duration-300 ${
          theme === "dark"
  ...
  <section className="mb-16 px-4">
    <div className="text-center mb-12">
      <h2 className="text-3xl font-bold mb-4">Explora Nuestras Categorías</h2>
      <p className={`text-lg max-w-3xl mx-auto ${
        theme === "dark" ? "text-gray-400" : "text-gray-600"
      }`}>Encuentra las mejores piezas para tu vehículo en nuestras categorías especializadas</p>
    </div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
      {[
        ...
        >
          <div className={`w-20 h-20 mx-auto mb-4 rounded-2xl flex items-center justify-center text-3xl transition-all duration-300 group-hover:scale-110 ${
            theme === "dark" 
  ...
  <section className="mb-16 px-4">
    <div className="flex flex-col md:flex-row justify-between items-center mb-8">
      <div>
        ...
        <p className={`mt-2 ${
          theme === "dark" ? "text-gray-400" : "text-gray-600"
        }`}>Las piezas más vendidas esta semana</p>
      </div>
      <button className={`mt-4 md:mt-0 px-6 py-3 rounded-full font-medium ${
        theme === "dark" 
          ? "bg-gray-800 hover:bg-gray-700" 
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-lg font-bold line-clamp-2">{producto.name}</h3>
  ...
  {/* Banner Secundario */}
  <div className={`rounded-3xl overflow-hidden mb-16 h-64 md:h-80 ${
    theme === "dark" 
    ...
    <div className="relative h-full flex items-center">
      ...
      <div className="relative z-10 p-8 md:p-12 max-w-2xl">
        ...
        <p className={`text-lg mb-6 ${
          ...
          Nuestros expertos te ayudarán a encontrar la pieza perfecta para tu vehículo
        </p>
        <button className={`px-8 py-3 rounded-full font-bold flex items-center ${
          theme === "dark" 
  ...
  <section className="mb-16 px-4">
    <div className="text-center mb-12">
      ...
      <p className={`text-lg max-w-3xl mx-auto ${
        theme === "dark" ? "text-gray-400" : "text-gray-600"
      }`}>Experiencias reales de quienes confían en nuestros productos y servicio</p>
    </div>
      ...
      {[
        {
          ...
          comment: "La calidad de las refacciones es excepcional, siempre encuentro lo que necesito para mis clientes.",
          rating: 5
        },
        {
          name: "María González",
          role: "Dueña de taller",
          comment: "Excelente servicio al cliente y entrega rápida. Mis clientes quedan satisfechos con las piezas.",
          rating: 4
        },
        {
          name: "Carlos Rodríguez",
          role: "Aficionado a los autos",
          comment: "He comprado varias piezas para restaurar mi auto clásico y todas han sido de primera calidad.",
          rating: 5
        }
