      ...
      <div className="container px-4 mx-auto">
        ...
        {recomendaciones && recomendaciones.length > 0 && (
          <div className="mt-12">
            ...
            <div className="flex pb-4 space-x-4 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600">
              {[...recomendaciones]
                .sort(() => Math.random() - 0.5)
                .map((producto) => (
                  <div
                    key={producto.id}
                    className="w-[260px] flex-shrink-0 rounded-xl shadow-md transition hover:shadow-lg"
                  >
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <span
                            className={`px-2 py-1 rounded-full text-xs line-clamp-1 ${
                              theme === "dark" ? "bg-gray-700" : "bg-gray-200"
                            }`}
                          >
                            {producto.category}
                        ...
                        {/* Compatibilidades */}
                        {producto.compatibilities?.length > 0 && (
                          <div className="mb-1">
